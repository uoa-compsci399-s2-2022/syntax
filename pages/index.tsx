...
<code_block code_content="# Program to check if a number is prime or not
...
if flag:
		...
		print(num, 'is a prime number')" code_output="" system_output="" language="python3"></code_block>
`,
	});
	...
	return (
		<>
			...
			<Container sm display="flex" direction="column">
				<Text size={60} weight={"bold"} css={{ textAlign: "center" }}>
					syntax
				</Text>
				...
				<Card css={{ $$cardColor: isDark ? "#121212" : "white" }}>
					<Card.Body>
						<Toolbar
							editor={editor}
							drawingOpenHandler={drawingOpenHandler}
						/>
						<Spacer />
