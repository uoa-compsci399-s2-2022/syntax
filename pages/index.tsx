  ...
  if (!session) {
    return (
      ...
      <Container fluid justify='center' display='flex' direction='column'>
        <Row justify='center'>
        <Card isHoverable isPressable variant='bordered' css={{ mw: '212px'}} >
          <Link href='https://vercel.com/' target='_blank'>
            <svg width="212" height="44" viewBox="0 0 212 44" fill="none" xmlns="http://www.w3.org/2000/svg" href='https://vercel.com/'>
