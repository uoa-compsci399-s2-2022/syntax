		...
		<>
			...
			>
				...
				<Navbar.Content>
					...
					<Navbar.Item>
						{!session ? (
							<Button bordered ghost onClick={() => signIn()} responsive auto>
								Sign in
							</Button>
						) : (
							<Button bordered ghost onClick={() => signOut()} responsive auto>
								Sign Out
							</Button>
						)}
					</Navbar.Item>
			...
			<Text size={60} weight={"bold"} align="center">
				syntax
			</Text>
			<Text h2 align="center" weight="normal" size={32}>
